<?php
/**
 * Eglatone Theme Options Sanitization Functions
 *
 * @package Eglatone
 */
 ...
 */
function eglatone_sanitize_select( $input, $setting ) {
 ...
 */
function eglatone_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function eglatone_sanitize_post( $input ) {
 ...
 */
function eglatone_sanitize_image( $image, $setting ) {
    /*
 ...
 * @since Eglatone 0.1
 */
function eglatone_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function eglatone_sanitize_number_range( $number, $setting ) {
