jQuery(function(s) {
    var e = [
        ["#customize-theme-controls", "all", "ct-reset", "ct-reset-main", eglatoneCustomizerReset.confirm, eglatoneCustomizerReset.reset]
    ];
    s.each(e, function(e, o) {
        ...
        c.on("click", function(e) {
            ...
            var t = {
                ...
                nonce: eglatoneCustomizerReset.nonce.reset,
                section: o[1]
            };
